...
# WRITABLE runtime data → the PROJECT's .genesis/ (cwd-derived), never the plugin dir (read-only +
# version-churned) and never hook-dir-relative. The MANIFEST_DIR above stays hook-relative (read-only).
