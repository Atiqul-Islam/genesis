...
context: full
allowed-tools: Read, Write, Edit, Glob, Grep, Bash(pytest *), Bash(python *), Bash(cargo *), Bash(git *), Skill
---
...
For each directive, follow the equivalent behavior in `${CLAUDE_PLUGIN_ROOT}/skills/dev-agent/SKILL.md`. The augmentations below are the **only** behavioral changes.
