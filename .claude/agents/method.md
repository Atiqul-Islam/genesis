...
tools: Read, Write, Edit, Bash, Glob, Grep, SendMessage, mcp__genesis-memory__store, mcp__genesis-memory__recall, mcp__genesis-memory__consolidate
hooks:
  SessionStart:
    - matcher: "startup|resume|compact"
      hooks:
        - type: command
          command: '"${CLAUDE_PROJECT_DIR}/.genesis/bin/genesis-hook" inject "${CLAUDE_PROJECT_DIR}/.genesis/expertise" method'
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
